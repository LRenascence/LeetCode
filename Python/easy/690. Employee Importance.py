...
class Solution:
    def getImportance(self, employees, id):
        ...
        for i in emps[id].subordinates:
            subordinatesList.append(i)
        while subordinatesList:
            curEmp = emps[subordinatesList.pop(0)]
            result += curEmp.importance
            for i in curEmp.subordinates:
                subordinatesList.append(i)
        return result
